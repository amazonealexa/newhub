...
function hexToRGB(a, e) {
...
} - 1 < navigator.platform.indexOf("Win") ? (0 != $(".main-panel").length && new PerfectScrollbar(".main-panel", {
    wheelSpeed: 2,
    wheelPropagation: !0,
    minScrollbarLength: 20,
    suppressScrollX: !0
}), 0 != $(".sidebar .sidebar-wrapper").length && (new PerfectScrollbar(".sidebar .sidebar-wrapper"), $(".table-responsive").each((function() {
    ...
    (-1 < navigator.platform.indexOf("Win") ? $(".ps") : $(window)).scroll((function() {
        ...
        $(this).closest(".navbar").removeClass("navbar-transparent").addClass("dark-color")
    })).on("hide.bs.collapse", (function() {
        $(this).closest(".navbar").addClass("navbar-transparent").removeClass("dark-color")
    ...
    var a = $(this);
    1 == blackDashboard.misc.navbar_menu_visible ? ($html.removeClass("nav-open"), blackDashboard.misc.navbar_menu_visible = 0, setTimeout((function() {
        a.removeClass("toggled"), $(".bodyClick").remove()
    }), 550)) : (setTimeout((function() {
        a.addClass("toggled")
    }), 580), $('<div class="bodyClick"></div>').appendTo("body").click((function() {
    ...
    if (seq = seq2 = 0, 0 == $full_screen_map.length && 0 == $(".bd-docs").length) {
        ...
        $navbar.hasClass("dark-color") && 991 < $(window).width() ? $navbar.removeClass("dark-color").addClass("navbar-transparent") : $navbar.hasClass("navbar-transparent") && $(window).width() < 991 && "false" != a && $navbar.addClass("dark-color").removeClass("navbar-transparent")
    }
})), blackDashboard = {
    misc: {
    ...
    initMinimizeSidebar: function() {
        0 != $(".sidebar-mini").length && (sidebar_mini_active = !0), $("#minimizeSidebar").click((function() {
            $(this), 1 == sidebar_mini_active ? ($("body").removeClass("sidebar-mini"), sidebar_mini_active = !1, blackDashboard.showSidebarMessage("Sidebar mini deactivated...")) : ($("body").addClass("sidebar-mini"), sidebar_mini_active = !0, blackDashboard.showSidebarMessage("Sidebar mini activated..."));
    ...
    $("#usernameemail").show(), $("#password").hide(), $("#apikey").hide()
})), $("#1").click((function() {
    $("#usernameemail").hide(), $("#password").show(), $("#apikey").hide()
})), $("#2").click((function() {
    $("#usernameemail").hide(), $("#password").hide(), $("#apikey").show()
}));